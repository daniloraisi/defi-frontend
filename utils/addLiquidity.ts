 ...
 * constant
 */
export const addLiquidity = async (signer: Signer, addCDAmountWei: BigNumber, addEtherAmountWei: BigNumber) => {
  try {
 ...
 */
export const calculateCD = async (_addEther = "0", etherBalanceContract: BigNumber, cdTokenReserve: BigNumber) => {
